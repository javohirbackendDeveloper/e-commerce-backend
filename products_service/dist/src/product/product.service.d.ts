...
export declare class ProductService {
    ...
    constructor(categoryService: CategoryService, prismaService: PrismaService, searchService: SearchService, cloudinaryService: CloudinaryService, cacheManager: Cache);

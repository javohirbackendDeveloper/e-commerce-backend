...
const punkt_admin_service_1 = require("./punkt-admin/punkt-admin.service");
...
exports.StaffServiceModule = StaffServiceModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [],
        providers: [tezbuy_packages_1.RmqService, punkt_admin_service_1.PunktAdminService, prisma_service_1.PrismaService],
    })
], StaffServiceModule);
//# sourceMappingURL=staff_service.module.js.map